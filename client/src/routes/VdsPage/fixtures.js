export const reviews = [
    {
        ...
        "title": "Mopos",
        "link": "Узнать больше >",
        "text": "Отличный сервис! Мобильные прокси это единственный способ комфортного спама Вконтакте не\n" +
        ...
        "                                сервиса у меня только положительные эмоции ведь его работа -стабильная, а",
        "comments": [
            {
                "id": "qwerqwer",
